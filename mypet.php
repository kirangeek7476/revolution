<?php
    ...
    $sql = "SELECT * FROM petitions WHERE userid = '$userid'";
    $env = $conn->query($sql);
?>
...
<head>
  ...
  <link rel="stylesheet" href="mypetcss.css">
...
logout
    ...
    <div class="envban" style="position: relative; top:-860px"><img src="yourpet1.png" height="700px" width="100%"></div>
    <h1>Petitions you started"...</h1>
    <?php
