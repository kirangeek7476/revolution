<?php
    ...
    $sql = "SELECT *
    FROM petitions WHERE typeid = 11";
    $env = $conn->query($sql);
?>
...
logout
    ...
    <div class="envban" style="position: relative; top:-860px"><img src="envr.png" height="700px" width="100%"></div>
    <h1>Petitions based on "Environment"...</h1>
    <?php
