<?php
    ...
    $sql = "SELECT *
    FROM petitions WHERE typeid = 16";
    $env = $conn->query($sql);
?>
...
logout
    ...
    <div class="envban" style="position: relative; top:-860px"><img src="anm.png" height="700px" width="100%"></div>
    <h1>Petitions based on "Animal rights"...</h1>
    <?php
