<?php
    ...
    $id = $_SESSION['userid'];
    $sql = "SELECT *
    FROM petitions WHERE progressval = 100 and userid = $id";
    $env = $conn->query($sql);
?>
...
logout
    ...
    <div class="envban" style="position: relative; top:-860px"><img src="vic.png" height="700px" width="100%"></div>
    <h1>Success Petitions...</h1>
    <?php
