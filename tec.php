<?php
    ...
    $sql = "SELECT *
    FROM petitions WHERE typeid = 18";
    $env = $conn->query($sql);
?>
...
logout
    ...
    <div class="envban" style="position: relative; top:-860px"><img src="tech.png" height="700px" width="100%"></div>
    <h1>Petitions based on "Technology"...</h1>
    <?php
