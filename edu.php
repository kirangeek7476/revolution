<?php
    ...
    $sql = "SELECT *
    FROM petitions WHERE typeid = 12";
    $env = $conn->query($sql);
?>
...
logout
    ...
    <div class="envban" style="position: relative; top:-860px"><img src="edu.png" height="700px" width="100%"></div>
    <h1>Petitions based on "Education"...</h1>
    <?php
