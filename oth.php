<?php
    ...
    $sql = "SELECT *
    FROM petitions WHERE typeid = 20";
    $env = $conn->query($sql);
?>
...
logout
    ...
    <div class="envban" style="position: relative; top:-860px"><img src="other.png" height="700px" width="100%"></div>
    <h1>Petitions based on "Other Categories"...</h1>
    <?php
