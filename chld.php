<?php
    ...
    $sql = "SELECT *
    FROM petitions WHERE typeid = 15";
    $env = $conn->query($sql);
?>
...
<head>
  ...
  <link rel="stylesheet" href="chld.css">
...
logout
    ...
    <div class="envban" style="position: relative; top:-860px"><img src="chld (1).png" height="700px" width="100%"></div>
    <h1>Petitions based on "Child rights"...</h1>
    <?php
