<?php
    ...
    $sql = "SELECT *
    FROM petitions WHERE typeid = 13";
    $env = $conn->query($sql);
?>
...
logout
    ...
    <div class="envban" style="position: relative; top:-860px"><img src="hlth.png" height="700px" width="100%"></div>
    <h1>Petitions based on "Health"...</h1>
    <?php
