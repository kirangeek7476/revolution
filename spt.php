<?php
    ...
    $sql = "SELECT *
    FROM petitions WHERE typeid = 17";
    $env = $conn->query($sql);
?>
...
<head>
  ...
  <link rel="stylesheet" href="hlth.css">
...
logout
    ...
    <div class="envban" style="position: relative; top:-860px"><img src="sportban.png" height="700px" width="100%"></div>
    <h1>Petitions based on "sports"...</h1>
    <?php
